"""Generate stratified sample worksheet for manual anchor geolocation.

Run:
    python3 src/oss_validation/generate_anchor_worksheet.py

Outputs:
    data/processed/stratified_100_anchor_worksheet.csv
"""
