...
Run:
    cd /path/to/repo
    python tier2_positional_accuracy/scripts/build_manual_worksheet.py
"""
...
def main():
    ...
    # Paths
    base_path = Path('.')
    stratified_path = base_path / 'tier2_positional_accuracy/data/stratified100_sample_master.csv'
    ...
    output_path = base_path / 'tier2_positional_accuracy/data/stratified100_manual_geocoding.csv'
